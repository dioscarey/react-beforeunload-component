 ...
 * @param {*} props.modalComponentHandler
 * @param {Function} props.beforeUnload
 * @param {Object} props.beforeUnloadSendBeacon
...
function BeforeUnloadComponent ({
  ...
  return React.createElement(React.Fragment, null, [
    showModal && defaultComponentAlert({ handleModalLeave, handleModalCancel }),
    React.createElement('span', { ref: childEle }, children),
  ])
}
